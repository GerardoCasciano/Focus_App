...
public class SegnalazioniPerMappaController {
    ...
    public ResponseEntity<List<SegnalazioneMappaDTO>> getSegnalazioni(
        ...
        try {
            ...
            System.out.println("Segnalazioni recuperate: " + lista.size());
    ...
    public ResponseEntity<List<SegnalazioneMappaDTO>> getSegnalazioniVicine(
        ...
        try {
            ...
            System.out.println("Trovate " + vicine.size() + " segnalazioni nel raggio di " + raggio + " metri");
            return ResponseEntity.ok(vicine);
        } catch (Exception e) {
            System.err.println("Errore nella query PostGis: " + e.getMessage());
            return ResponseEntity.internalServerError().build();
        }
    }
    ...
    public ResponseEntity<String> creaSegnalazione(
            @RequestPart("dati") CreaSegnalazioneDTO dto,  // <-- cambiato qui
